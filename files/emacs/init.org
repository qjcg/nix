...
*** TODO Ultimate Developer Experience (DX) [4/10]
    - [X] Git (magit)
...
** Themes
   ...
   #+begin_src emacs-lisp
     ...
     (use-package exotica-theme :ensure)
     (use-package organic-green-theme :ensure)
...
** Completion
   ...
   #+BEGIN_SRC emacs-lisp
     ;; DISABLE ido-mode, pilot replacing it with Ivy (below).
