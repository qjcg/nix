...
*** Register-based approach
   ...
   - This ~window-configuration-to-register~ based approach should handle most scenarios: [[https://www.reddit.com/r/emacs/comments/1m73gs/how_do_you_manage_multiple_workspaces/cc6g59z/][reddit: how do you manage multiple workspaces?]]

     #+name: Sample register-based window/buffer management workflow
     | Keys      | Description                                           |
     |-----------+-------------------------------------------------------|
     |           | (Configure a first set of buffers and window layout)  |
     | C-c r w 1 | Write current window layout to register 1             |
     | C-x 1     | Clear all but currently selected buffer window        |
     |           | (Configure a second set of buffers and window layout) |
     | C-c r w 2 | Write current window layout to register 2             |
     | C-c r j 1 | Jump to window layout in register 1                   |
     | C-c r j 2 | Jump to window layout in register 2                   |
